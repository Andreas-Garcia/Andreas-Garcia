Un·e développeur·se ERP / fullstack - Fondation Terre de Liens - Crest, France
Terre de Liens
💡
Structure de l'ESS
CDD
...
36000 - 41000€ brut (Annuel)
A partir de 3 année(s) d'exp.
Publiée le 29/07/2026
Candidater
Annonces similaires
Signaler l'offre
Envie d'en savoir plus sur cette structure ?
Préserver les terres agricoles, faciliter l'accès des paysans à la terre, développer l'agriculture biologique et paysanne et faire de la terre un bien commun pa…

Découvrir la page de Terre de Liens
...
Les missions seront réalisées en collaboration avec l'équipe numérique Fondation et les salarié·es des 22 structures nationales et régionales. Dans le contexte d'évolution du service numérique, il s'agit principalement de :

1/ Développement et administration ERP/CRM (60%)
...
Assurer un support utilisateur de niveaux 2 et 3 principalement auprès des référents numériques métiers
...
3/ Administration d'autres outils Terre de Liens (5%)
...
4/ Contribuer à la vie d'équipe (5%)
...
Diplôme : équivalent ingénieur BAC+⅘ en informatique ou équivalent

Expérience

3 ans minimum en développement backend en équipe (requise)
Développement frontend web (souhaitée)
Utilisation d'ETL (souhaitée)
Ecriture de tests unitaires automatisés (souhaitée)
Configuration de progiciel type ERP/CRM (idéalement Salesforce) (souhaitée)

Compétences techniques

Développement d'application basée sur un SGBD avec un langage orienté objet et un ORM
Concevoir une base de données
Requêter et maintenir une base de données
Configurer un ERP / CRM, idéalement une expérience Salesforce
Faire des revues de code
Gérer le code dans un VCS (git idéalement)
Développement frontend web (apprécié)
Connaissance du RGPD

Qualités humaine / savoir être

Curieux.se, logique, enthousiaste, à l'écoute
Autonome, pragmatique, adaptable
Rigoureux.se
Esprit de synthèse
Goût pour le travail en équipe
Intérêt pour les métiers de Terre de Liens et/ou de l'ESS
Adhésion et/ou contributions aux principes et valeurs de l'ESS (exemple: expérience dans l'associatif, intérêt pour le libre et le partage …)
...
Prise de poste : idéalement Octobre 2026
...
Merci d'envoyer votre lettre de motivation ainsi que votre CV (avec Nom et Prénom dans l'intitulé du document, svp) au plus tard le 17/07/2026.

Process de recrutement en 3 étapes :

Un échange téléphonique avec notre assistante RH la semaine du 27/07/2026
Un entretien en visio opérationnel avec le responsable SI le 18/08/2026 ou 19/08/2026
Un entretien en présentiel à CREST avec l'équipe numérique + notre RRH le 01/09/2026
