...
Open-source maintainer with 4+ years building **Python** and **Django** backend systems for production. Founded TheMusicTree; published **AudioMeta Python** (https://pypi.org/project/audiometa-python/) (25k+ downloads, **1500+ tests**). Reliability, data integrity, and **clean code** matter to me in every system I ship.
...
Techniques: Python, Django REST Framework, PostgreSQL, REST APIs, SQL, Docker, GitHub Actions, pytest, Domain Modelling

Workflow: GitFlow, CI/CD, Unit Testing, Code Review, Agile/SCRUM, Clean Code, Documentation, Data Integration, Remote
...
Normalised **1,300+** raw external records into a scalable taxonomy of 15 top-level categories.
Resolved duplicates and standardised inconsistent labels to support accurate automated matching.
Combined domain expertise and structured data modelling to improve matching precision.
...
**Open to:** Python/Django backend roles, healthcare & impact-driven tech, full remote
