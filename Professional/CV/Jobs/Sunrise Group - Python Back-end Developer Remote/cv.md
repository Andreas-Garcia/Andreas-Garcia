...
Open-source maintainer with 4+ years building **Python** and **Django** backend systems for production. Founded TheMusicTree; published **AudioMeta Python** (https://pypi.org/project/audiometa-python/) (24k+ downloads, **1500+ tests**). Reliability, data integrity, and **clean code** matter to me in every system I ship.
