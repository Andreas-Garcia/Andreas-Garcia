...
Backend engineer and **open-source maintainer** with a strong record of building **production-ready** libraries and APIs. Founded the TheMusicTree ecosystem and published **AudioMeta Python** (https://pypi.org/project/audiometa-python/) with 25k+ downloads and **1500+ unit tests**, demonstrating **clean code**, **modular design**, and high-coverage testing.
