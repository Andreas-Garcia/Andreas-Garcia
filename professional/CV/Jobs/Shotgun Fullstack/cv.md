...
Full-stack engineer passionate about building products that reach large audiences, with experience in React, Next.js ecosystems. Deeply passionate about music and entertainment, founded BehindTheMusicTree (https://github.com/behindthemusictree), an open-source music technology ecosystem including AudioMeta Python (https://pypi.org/project/audiometa-python/) with 12 000+ downloads.
...
Created AudioMeta Python (https://pypi.org/project/audiometa-python/) library achieving 12 000+ downloads, with test suite of 1500+ unit tests.
...
Implemented REST API services in Java using Data Transfer Object pattern for event handling.
Added event handling in JavaScript on website layer using three-tier architecture and API calls.
Manipulated complex data structures in RDF4J graph database and improved ontologies to support research.
...
- Backend: Node.js, Python, Django REST Framework, Java, Spring Boot, PostgreSQL, GraphQL
- Frontend: React, Next.js, TypeScript, JavaScript, Apollo
- DevOps: Docker, Docker Hub, GitHub Actions, CI/CD
- Testing: pytest, mypy, ruff, Cypress, Detox
...
**Open to:** Full-stack engineering opportunities in music, entertainment, and technology companies
